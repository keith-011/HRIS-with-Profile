...
const ModalBase = () => {
  ...
  return (
    <>
      ...
      />
      <div
        className={`absolute right-0 z-50 flex w-full lg:w-1/2 ${!isModalOpen && "translate-x-full"} h-screen flex-col justify-between bg-accent-100 transition-transform duration-500 max-sm:w-full`}
      >
        ...
        <div className="grow">{content?.content}</div>
